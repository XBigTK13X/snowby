...
local osc_color_front = '808080'
local osc_color_back = '000000'

local osc_styles = {
    bigButtons = "{\\blur0\\bord0\\1c&H"..osc_color_front.."\\3c&H"..osc_color_front.."\\fs50\\fnmpv-osd-symbols}",
    smallButtonsL = "{\\blur0\\bord0\\1c&H"..osc_color_front.."\\3c&H"..osc_color_front.."\\fs19\\fnmpv-osd-symbols}",
    smallButtonsLlabel = "{\\fscx105\\fscy105\\fn" .. mp.get_property("options/osd-font") .. "}",
    smallButtonsR = "{\\blur0\\bord0\\1c&H"..osc_color_front.."\\3c&H"..osc_color_front.."\\fs30\\fnmpv-osd-symbols}",
    topButtons = "{\\blur0\\bord0\\1c&H"..osc_color_front.."\\3c&H"..osc_color_front.."\\fs12\\fnmpv-osd-symbols}",

    elementDown = "{\\1c&H"..osc_color_front.."}",
    timecodes = "{\\blur0\\bord0\\1c&H"..osc_color_front.."\\3c&H"..osc_color_front.."\\fs20}",
    vidtitle = "{\\blur0\\bord0\\1c&H"..osc_color_front.."\\3c&H"..osc_color_front.."\\fs12\\q2}",
    box = "{\\rDefault\\blur0\\bord1\\1c&H"..osc_color_back.."\\3c&H"..osc_color_front.."}",

    topButtonsBar = "{\\blur0\\bord0\\1c&H"..osc_color_front.."\\3c&H"..osc_color_front.."\\fs18\\fnmpv-osd-symbols}",
    smallButtonsBar = "{\\blur0\\bord0\\1c&H"..osc_color_front.."\\3c&H"..osc_color_front.."\\fs28\\fnmpv-osd-symbols}",
    timecodesBar = "{\\blur0\\bord0\\1c&H"..osc_color_front.."\\3c&H"..osc_color_front.."\\fs27}",
    timePosBar = "{\\blur0\\bord".. user_opts.tooltipborder .."\\1c&H"..osc_color_front.."\\3c&H"..osc_color_back.."\\fs30}",
    vidtitleBar = "{\\blur0\\bord0\\1c&H"..osc_color_front.."\\3c&H"..osc_color_front.."\\fs18\\q2}",

    wcButtons = "{\\1c&H"..osc_color_front.."\\fs24\\fnmpv-osd-symbols}",
    wcTitle = "{\\1c&H"..osc_color_front.."\\fs24\\q2}",
    wcBar = "{\\1c&H"..osc_color_back.."}",
}
...
layouts["slimbox"] = function ()
    ...
    local styles = {
        box = "{\\rDefault\\blur0\\bord1\\1c&H"..osc_color_back.."\\3c&H"..osc_color_front.."}",
        timecodes = "{\\1c&H"..osc_color_front.."\\3c&H"..osc_color_back.."\\fs20\\bord2\\blur1}",
        tooltip = "{\\1c&H"..osc_color_front.."\\3c&H"..osc_color_back.."\\fs12\\bord1\\blur0.5}",
    }
