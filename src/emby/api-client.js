...
module.exports = {
    apiClient: {
        ...
        embyItems: (parentId, searchParams) => {
            ...
            return httpClient.get(url).then(itemsResponse => {
        ...
        seasons: seriesId => {
            ...
            return httpClient.get(url).then(seasonsResponse => {
        ...
        episodes: (seriesId, seasonId) => {
            ...
            return httpClient.get(url).then(episodesResponse => {
